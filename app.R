...
# "National_Review", "Business_Insider", "Talking_Points_Memo",
# "Fox_News", "CNN", "Guardian", "NPR", "Washington_Post")
data_ <- load_data("../app/data/Tidy_Data/tidy_sent_data_All.csv")
data_atl <- load_data("../app/data/Tidy_Data/tidy_sent_data_Atlantic.csv")
data_rtr <- load_data("../app/data/Tidy_Data/tidy_sent_data_Reuters.csv")
data_NYP <- load_data("../app/data/Tidy_Data/tidy_sent_data_New_York_Post.csv")
data_bb <- load_data("../app/data/Tidy_Data/tidy_sent_data_Breitbart.csv")
data_NYT <- load_data("../app/data/Tidy_Data/tidy_sent_data_New_York_Times.csv")
data_Buzz <- load_data("../app/data/Tidy_Data/tidy_sent_data_Buzzfeed_News.csv")
data_ntl <- load_data("../app/data/Tidy_Data/tidy_sent_data_National_Review.csv")
data_busin <- load_data("../app/data/Tidy_Data/tidy_sent_data_Business_Insider.csv")
data_tpm <- load_data("../app/data/Tidy_Data/tidy_sent_data_Talking_Points_Memo.csv")
data_FOX <- load_data("../app/data/Tidy_Data/tidy_sent_data_Fox_News.csv")
data_CNN <- load_data("../app/data/Tidy_Data/tidy_sent_data_CNN.csv")
data_gdn <- load_data("../app/data/Tidy_Data/tidy_sent_data_Guardian.csv")
data_NPR <- load_data("../app/data/Tidy_Data/tidy_sent_data_NPR.csv")
data_WaPo <- load_data("../app/data/Tidy_Data/tidy_sent_data_Washington_Post.csv")

occ_by_time <- load_data("../app/data/Tidy_Data/tidy_occ_by_time_data.csv")
